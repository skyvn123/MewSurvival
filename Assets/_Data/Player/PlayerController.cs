...
public class PlayerController : MonoBehaviour
{
    ...
    {
		if (movement.isMoving) _animator.SetBool("IsMoving", true);
        else _animator.SetBool("IsMoving", false);

        if (movement.isSprinting) _animator.SetBool("IsRuning", true);
	...
	{
        movement.isMoving = context.started || context.performed;
